$(function(){
	...
	$.getJSON(baseUrl+'/api/diantou/table/getTableInfo/gameType/2/tableId/'+tableId,function(data){
		if(data.code == 1){
...
function getTableCount(){
	...
	// 获取走势图数据
	$.getJSON(baseUrl+'/api/diantou/table/getTableCount/gameType/2/tableId/'+tableId+'/xue/'+xue,function(data){
		if(data.code == 1){
